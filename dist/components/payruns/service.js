...
class PayRunService {
    ...
    async generatePayslips(payRunId) {
        ...
        for (const employee of employees) {
            ...
            console.log(`[generatePayslips] Employé ${employee.id}: ${workedDays} jours travaillés`);
            ...
            console.log(`[generatePayslips] Création bulletin pour employé ${employee.id}: montant brut ${grossAmount}, jours travaillés ${joursTravailles}`);
